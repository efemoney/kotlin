...
public class KotlinTestUtils {
    ...
    public static void assertAllTestsPresentByMetadataWithExcluded(
        ...
        assertAllTestsPresentByMetadata(testCaseClass, testDataDir, filenamePattern, excludedPattern, TargetBackend.ANY, recursive, excludeDirs);
    }
    ...
    public static void assertAllTestsPresentByMetadata(
        ...
        assertAllTestsPresentByMetadata(testCaseClass, testDataDir, filenamePattern, null, targetBackend, recursive, excludeDirs);
    }
