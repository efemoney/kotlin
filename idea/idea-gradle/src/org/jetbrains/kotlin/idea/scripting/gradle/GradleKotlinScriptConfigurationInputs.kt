...
class GradleKotlinScriptConfigurationInputs(override var stamp: Long, private val timeStamp: Long) : CachedConfigurationInputs {
    override fun isUpToDate(project: Project, file: VirtualFile, ktFile: KtFile?): Boolean {
        ...
        return actualStamp == this && project.service<GradleScriptInputsWatcher>().areAffectedFilesUpToDate(file, timeStamp)
    }
