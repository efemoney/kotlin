...
public class CommonDecompiledTextFromJsMetadataTestGenerated extends AbstractCommonDecompiledTextFromJsMetadataTest {
    ...
    public void testAllFilesPresentInDecompiledText() throws Exception {
        KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
    }
    ...
    public static class AnnotatedEnumEntry extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInAnnotatedEnumEntry() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/AnnotatedEnumEntry"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
    ...
    public static class AnnotatedParameterInEnumConstructor extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInAnnotatedParameterInEnumConstructor() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/AnnotatedParameterInEnumConstructor"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
    ...
    public static class AnnotatedParameterInInnerClassConstructor extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInAnnotatedParameterInInnerClassConstructor() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/AnnotatedParameterInInnerClassConstructor"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
    ...
    public static class Annotations extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInAnnotations() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/Annotations"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
    ...
    public static class AnnotationsOnPrimaryCtr extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInAnnotationsOnPrimaryCtr() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/AnnotationsOnPrimaryCtr"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
    ...
    public static class ClassWithClassObject extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInClassWithClassObject() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/ClassWithClassObject"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
    ...
    public static class ClassWithNamedClassObject extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInClassWithNamedClassObject() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/ClassWithNamedClassObject"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
    ...
    public static class Const extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInConst() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/Const"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
    ...
    public static class DependencyOnNestedClasses extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInDependencyOnNestedClasses() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/DependencyOnNestedClasses"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
    ...
    public static class Enum extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInEnum() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/Enum"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
    ...
    public static class FlexibleTypes extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInFlexibleTypes() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/FlexibleTypes"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
    ...
    public static class FunctionTypes extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInFunctionTypes() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/FunctionTypes"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
    ...
    public static class FunctionalTypeWithNamedArguments extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInFunctionalTypeWithNamedArguments() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/FunctionalTypeWithNamedArguments"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
    ...
    public static class Inherited extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInInherited() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/Inherited"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
    ...
    public static class InnerClasses extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInInnerClasses() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/InnerClasses"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
    ...
    public static class LocalClassAsTypeWithArgument extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInLocalClassAsTypeWithArgument() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/LocalClassAsTypeWithArgument"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
    ...
    public static class Modifiers extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInModifiers() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/Modifiers"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
    ...
    public static class NestedClasses extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInNestedClasses() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/NestedClasses"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
    ...
    public static class Object extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInObject() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/Object"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
    ...
    public static class SecondaryConstructors extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInSecondaryConstructors() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/SecondaryConstructors"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
    ...
    public static class SimpleClass extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInSimpleClass() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/SimpleClass"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
    ...
    public static class TypeModifiers extends AbstractCommonDecompiledTextFromJsMetadataTest {
        ...
        public void testAllFilesPresentInTypeModifiers() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/decompiler/decompiledText/TypeModifiers"), Pattern.compile("^([^\\.]+)$"), null, TargetBackend.JS, true);
        }
    }
}
