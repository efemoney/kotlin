...
public class IrPropertyAccessorsInlineTestsGenerated extends AbstractIrPropertyAccessorsInlineTests {
    ...
    public void testAllFilesPresentInProperty() throws Exception {
        KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("compiler/testData/codegen/boxInline/property"), Pattern.compile("^(.+)\\.kt$"), null, TargetBackend.JS_IR, true);
    }
