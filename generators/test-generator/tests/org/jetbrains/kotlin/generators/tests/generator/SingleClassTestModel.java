        ...
        public void generateBody(@NotNull Printer p) {
            ...
            if (targetBackend != TargetBackend.ANY) {
                assertTestsPresentStr = String.format(
                        "KotlinTestUtils.assertAllTestsPresentInSingleGeneratedClass(this.getClass(), new File(\"%s\"), Pattern.compile(\"%s\"), %s, %s.%s);",
                ...
                assertTestsPresentStr = String.format(
                        "KotlinTestUtils.assertAllTestsPresentInSingleGeneratedClass(this.getClass(), new File(\"%s\"), Pattern.compile(\"%s\"), %s);",
